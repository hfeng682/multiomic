...
def parse_args():
    parser = argparse.ArgumentParser(
        description="scRNA-seq data imputation using moNetImpute, a variation of DeepImpute."
    )
    parser.add_argument("inputData", type=str, help="Path to input scRNAseq data.")
    parser.add_argument("targetData", type=str, help="Path to target DNA Methylation data.")
    parser.add_argument(
        "-o", "--output",
        type=str,
        default="./imputed.csv",
        help="Path to output imputed DNA methylation data. Default: ./imputed.csv",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="rows",
        help="Cell dimension in the input data. Default: rows",
    )
    parser.add_argument(
        "--cell-axis-target",
        type=str,
        choices=["rows", "columns"],
        default="rows",
        help="Cell dimension in the target data. Default: rows",
    )
    parser.add_argument(
        "--limit",
        type=str,
